...
(function() {
  ...
  // Dọn dẹp triệt để các phần tử thừa từ các phiên bản trước
  ['opencode-btn-git-changes', 'opencode-git-drawer', 'opencode-git-backdrop', 'opencode-btn-router-hub', 'opencode-router-modal', 'opencode-router-backdrop'].forEach(id => {
  ...
  function startObserving() {
    ...
    if (root) {
      ...
      setTimeout(unblockAutoAcceptSwitch, 400);
      setTimeout(renderContextHUD, 500);
    } else {
